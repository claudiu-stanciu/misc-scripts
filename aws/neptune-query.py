...
# The following script requires python 3.6+ (sudo yum -y install python3)
...
def get_canonical_uri_and_payload(query_type, query):
    ...
    # retrieve sparql queries status
        ...
        print(
            'Third parameter should be from ["gremlin", "sparql", "sparqlupdate", "loader", "status", "sparql-status"] but is "' + query_type + '".')
        sys.exit()
